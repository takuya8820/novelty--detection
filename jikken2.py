	...
	if ite % 1000 == 0:
		...
		for ind, testFakeRatio in enumerate(testFakeRatios):
			...
			if ind == 0:
				...
				path = os.path.join(visualPath,"img_train_{}_{}_{}_{}.png".format(postFix,testFakeRatio,noiseSigma,ite))
				plt.savefig(path)
				#--------------
				...
				path = os.path.join(visualPath,"img_test_true_{}_{}_{}_{}.png".format(postFix,testFakeRatio,noiseSigma,ite))
				plt.savefig(path)
				#--------------
				...
				path = os.path.join(visualPath,"img_test_fake_{}_{}_{}_{}.png".format(postFix,testFakeRatio,noiseSigma,ite))
				plt.savefig(path)
				#--------------
